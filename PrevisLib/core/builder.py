...
class PrevisBuilder:
    ...
    def _step_generate_precombined(self) -> bool:
        ...
        # Run Creation Kit
        success = self.ck_wrapper.generate_precombined(self.data_path, self.output_path)
    ...
    def _step_archive_meshes(self) -> bool:
        ...
        success = self.archive_wrapper.create_archive(archive_path, self.output_path, compress=True)
    ...
    def _step_generate_previs(self) -> bool:
        ...
        # Run Creation Kit
        success = self.ck_wrapper.generate_previs_data(self.data_path, self.temp_path)
    ...
    def _step_final_packaging(self) -> bool:
        ...
        if self.temp_path.exists() and not fs.is_directory_empty(self.temp_path):
            success = self.archive_wrapper.create_archive(vis_archive_path, self.temp_path, compress=True)
    ...
    def cleanup(self) -> bool:
        ...
        dirs_to_clean = [self.output_path, self.temp_path]
