...
from PrevisLib.utils.validation import (
    validate_plugin_name, validate_tool_path, validate_directory,
    check_tool_version, validate_ckpe_config, validate_archive_format,
    RESERVED_PLUGIN_NAMES, VALID_PLUGIN_EXTENSIONS
)
...
class TestPluginValidation:
    ...
    def test_valid_plugin_names(self):
        ...
        valid_names = [
            ...
            "TestPlugin.esm", 
            "Patch.esl",
            "Very_Long_Plugin_Name.esp",
            "mod-with-hyphens.esp",
            "123numbers.esp"
        ]
